...
<div class="col-lg-3 col-md-3 actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Content'), array('action' => 'delete', $content['Content']['id']), array('class'=>'btn btn-primary'), __('Are you sure you want to delete # %s?', $content['Content']['id'])); ?> </li>
