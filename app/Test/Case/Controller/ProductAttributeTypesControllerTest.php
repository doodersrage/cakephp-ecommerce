<?php
App::uses('ProductAttributeTypesController', 'Controller');

/**
 * ProductAttributeTypesController Test Case
 *
 */
class ProductAttributeTypesControllerTest extends ControllerTestCase {
